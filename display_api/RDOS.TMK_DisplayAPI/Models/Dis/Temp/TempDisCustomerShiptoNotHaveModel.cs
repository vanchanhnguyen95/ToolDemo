...
{
    public class TempDisCustomerShiptoNotHaveModel
    {
    ...
    public class TempDisCustomerShiptoNotHaveListModel
    {
        public List<TempDisCustomerShiptoNotHaveModel> Items { get; set; }
