...
{
    public class TempDisCustomerShiptoSaleOrQuantityModel
    {
    ...
    public class TempDisCustomerShiptoSaleOrQuantityListModel
    {
        public List<TempDisCustomerShiptoSaleOrQuantityModel> Items { get; set; }
