...
{
    public class TempDisPosmForCustomerShiptoModel
    {
    ...
    public class TempDisPosmForCustomerShiptoListModel
    {
        public List<TempDisPosmForCustomerShiptoModel> Items { get; set; }
