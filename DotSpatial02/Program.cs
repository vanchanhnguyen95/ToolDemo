...
namespace DotSpatial02
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            GeoAPI.CoordinateSystems.ICoordinateSystem nycCS =
                CoordinateSystemWktReader.Parse(wktstring) as GeoAPI.CoordinateSystems.ICoordinateSystem;

            GeoAPI.CoordinateSystems.ICoordinateSystem baseCS =
                CoordinateSystemWktReader.Parse(latlongwkt) as GeoAPI.CoordinateSystems.ICoordinateSystem;
